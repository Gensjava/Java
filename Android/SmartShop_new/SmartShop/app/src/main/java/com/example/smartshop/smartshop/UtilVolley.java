    ...
    public void getCategory(){
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        someEventListener = (onSomeEventListener) mActivity;

                        someEventListener.someEvent("OnClickAdapterCategory","");

                        //mDualProducts.add(new ProductDual(mProductOne, mProductTwo));
            ...
            public void onErrorResponse(VolleyError error) {
                // TODO Auto-generated method stub
                Log.i("Сonstants.mCategory55",""+Сonstants.mCategory+" "+error);
            }
        });
