 ...
 */
public class AdapterCart extends ArrayAdapter<Order> implements View.OnClickListener {

    private final LayoutInflater mLayoutInflater;

    public AdapterCart(final Context context, final int resource, final List<Order> objects) {
